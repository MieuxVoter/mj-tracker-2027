...
class SurveyInterface:
    ...
    def reorder_grades(self, new_order: list[str]) -> "SurveyInterface":
        ...
        if set(new_order) != set(current_grades):
            ...
            raise ValueError(
                f"new_order must contain exactly the same grades as the survey. "
        ...
        cached_props = [
            'grades', 'nb_grades', '_intentions_colheaders', '_grades_colheaders',
            '_intentions_colheaders_idx', '_grades_colheaders_idx',
            '_no_opinion_colheader', '_grades_no_opinion_colheaders',
            '_grades_no_opinion_colheaders_idx', '_intentions_without_no_opinion_colheaders',
            '_intention_no_opinion_colheader', 'has_no_opinion_grade', 'is_no_opinion_last',
            'total_intentions', 'total_intentions_no_opinion', 'total_intentions_without_no_opinion',
